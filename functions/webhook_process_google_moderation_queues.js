...
exports.handler = async function (event, context) {
  ...
  const approvedFn = `${process.env.PROD_FN_PATH}webhook_clear_google-moderation_approved_queue`;
  const rejectedFn = `${process.env.PROD_FN_PATH}webhook_clear_google-moderation_rejected_queue`;
